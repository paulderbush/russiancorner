...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${process.env.SITE_URL || 'https://russiancorner.co.uk'}/success.html?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${process.env.SITE_URL || 'https://russiancorner.co.uk'}`,
    });
